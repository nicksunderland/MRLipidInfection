...
checks whether the file has already been downloaded and extracted.
...
```{r show_mr_scatter, fig.align="center", eval=TRUE, echo=FALSE, results='asis', eval = FALSE, include=FALSE}
# Get the file paths
